source [file join [file dirname [info script]] ./../../../top/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../ip/top_inst_clk_bfm_ip/sim/common/modelsim_files.tcl]
source [file join [file dirname [info script]] ./../../ip/top_inst_reset_bfm_ip/sim/common/modelsim_files.tcl]
...
namespace eval top_tb {
  ...
  proc get_common_design_files {QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [top::get_common_design_files "$QSYS_SIMDIR/../../top/sim/"]]
    set design_files [dict merge $design_files [top_inst_clk_bfm_ip::get_common_design_files "$QSYS_SIMDIR/../ip/top_inst_clk_bfm_ip/sim/"]]
    set design_files [dict merge $design_files [top_inst_reset_bfm_ip::get_common_design_files "$QSYS_SIMDIR/../ip/top_inst_reset_bfm_ip/sim/"]]
    return $design_files
  }
  
  proc get_design_files {QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    set design_files [list]
    set design_files [concat $design_files [top::get_design_files "$QSYS_SIMDIR/../../top/sim/" "$QUARTUS_INSTALL_DIR"]]
    set design_files [concat $design_files [top_inst_clk_bfm_ip::get_design_files "$QSYS_SIMDIR/../ip/top_inst_clk_bfm_ip/sim/" "$QUARTUS_INSTALL_DIR"]]
    set design_files [concat $design_files [top_inst_reset_bfm_ip::get_design_files "$QSYS_SIMDIR/../ip/top_inst_reset_bfm_ip/sim/" "$QUARTUS_INSTALL_DIR"]]
    lappend design_files "-makelib top_tb \"[normalize_path "$QSYS_SIMDIR/top_tb.v"]\"   -end"
    return $design_files
  }
