...
# ----------------------------------------
# ACDS 26.1 110 linux 2026.04.22.02:07:41
...
alias com {
  ...
  set common_design_files [dict values [top_juart::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [top_juart::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
