...
// $Id: //acds/rel/26.1/ip/iconnect/merlin/altera_merlin_traffic_limiter/altera_merlin_reorder_memory.sv#1 $
// $Revision: #1 $
// $Date: 2026/02/05 $
...
(
    ...
    reg [DATA_W - 1 : 0] out_payload_same_addr;
    reg                  is_same_addr;

    always @(posedge clk) begin
        out_payload_same_addr <= in_data;
    end

    always @(posedge clk) begin
        if (in_valid && in_ready && (mem_wr_addr == mem_rd_addr)) begin
            is_same_addr <= 1'b1;
        end
        else begin
            is_same_addr <= 1'b0;
    ...
    if (USE_FIFO == 1) begin
       ...
       // ---------------------------------
        ...
        always_comb     begin
               out_data  = is_same_addr ? out_payload_same_addr : out_payload;
...
`pragma questa_oem_00 ""
`endif