...
module top_altera_merlin_axi_slave_ni_19129_midkkly
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    top_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19129_yewqcxq #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_4lvwuxa #(
      .SYMBOLS_PER_BEAT (1),
    ...
    top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_fos7nlq #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_3s63o5y #(
             .SYMBOLS_PER_BEAT (1),
