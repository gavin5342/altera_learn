// top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_zyff54i.v

// Generated using ACDS version 26.1 110

`timescale 1 ps / 1 ps
module top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_zyff54i #(
		...
		input  wire [4:0] in_data,   //          .data,  Input Data port of Avalon Streaming Sink Interface
		...
		output wire [4:0] out_data   //          .data,  Output Data port of Avalon Streaming Source Interface
	);
	...
	top_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),   //   input,  width = 5,          .data
		.out_ready         (out_ready), //   input,  width = 1,   source0.ready
		.out_valid         (out_valid), //  output,  width = 1,          .valid
		.out_data          (out_data),  //  output,  width = 5,          .data
