// top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_4lvwuxa.v

// Generated using ACDS version 26.1 110

`timescale 1 ps / 1 ps
module top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_4lvwuxa #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 46,
		...
		input  wire [45:0] in_data,   //          .data,  Input Data port of Avalon Streaming Sink Interface
		...
		output wire [45:0] out_data   //          .data,  Output Data port of Avalon Streaming Source Interface
	);
	...
	top_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),   //   input,  width = 46,          .data
		.out_ready         (out_ready), //   input,   width = 1,   source0.ready
		.out_valid         (out_valid), //  output,   width = 1,          .valid
		.out_data          (out_data),  //  output,  width = 46,          .data
