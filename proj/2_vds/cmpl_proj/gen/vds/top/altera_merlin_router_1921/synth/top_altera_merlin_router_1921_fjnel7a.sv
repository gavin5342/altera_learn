...
//    output_name             top_altera_merlin_router_1921_fjnel7a
//    pkt_addr_h              67
//    pkt_addr_l              36
//    pkt_dest_id_h           110
//    pkt_dest_id_l           109
...
//    pkt_trans_read          71
//    pkt_trans_write         70
//    slaves_info             2:100:0x0:0x2000:write:1:0:0:1,1:010:0x2000:0x2008:both:1:0:0:1
//    st_channel_w            5
//    st_data_w               175
// ------------------------------------------

module top_altera_merlin_router_1921_fjnel7a_default_decode
  #(
  ...
  (output [110 - 109 : 0] default_destination_id,
...
module top_altera_merlin_router_1921_fjnel7a
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    top_altera_merlin_router_1921_fjnel7a_default_decode the_default_decode(
    ...
    always @* begin
        ...
        // slave 0: [0x0, 0x2000) : sel [13:13]
        if ( {address[13:13],{13 {1'b0}}} == 14'h0  && write_transaction  ) begin
            src_channel = 5'b100;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
        end

        // slave 1: [0x2000, 0x2008) : sel [13:3]
        if ( {address[13:3],{3 {1'b0}}} == 14'h2000   ) begin
            src_channel = 5'b010;
