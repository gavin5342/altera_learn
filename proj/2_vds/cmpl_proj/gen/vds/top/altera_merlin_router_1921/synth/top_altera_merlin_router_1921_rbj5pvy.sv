...
//    output_name             top_altera_merlin_router_1921_rbj5pvy
//    pkt_addr_h              67
//    pkt_addr_l              36
//    pkt_dest_id_h           110
//    pkt_dest_id_l           109
...
//    pkt_trans_read          71
//    pkt_trans_write         70
//    slaves_info             2:10:0x0:0x2000:read:1:0:0:1
//    st_channel_w            5
//    st_data_w               175
// ------------------------------------------

module top_altera_merlin_router_1921_rbj5pvy_default_decode
  #(
...
module top_altera_merlin_router_1921_rbj5pvy
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    top_altera_merlin_router_1921_rbj5pvy_default_decode the_default_decode(
    ...
    always @* begin
        ...
        if ( {address[13:13],{13 {1'b0}}} == 13'h0  && read_transaction  ) begin
            src_channel = 5'b10;
