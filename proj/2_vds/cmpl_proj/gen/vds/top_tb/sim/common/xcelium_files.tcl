source [file join [file dirname [info script]] ./../../../top/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../ip/top_inst_clk_bfm_ip/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../ip/top_inst_reset_bfm_ip/sim/common/xcelium_files.tcl]
...
namespace eval top_tb {
  ...
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR QUARTUS_INSTALL_DIR} {
    ...
    lappend design_files "xmvlog -zlib 1 -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"$QSYS_SIMDIR/top_tb.v\"  -work top_tb"
    return $design_files
  }
