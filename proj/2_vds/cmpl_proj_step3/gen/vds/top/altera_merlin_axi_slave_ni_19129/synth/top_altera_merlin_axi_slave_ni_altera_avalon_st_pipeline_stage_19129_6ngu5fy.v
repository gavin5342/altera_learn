// top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_6ngu5fy.v

// Generated using ACDS version 26.1 110

`timescale 1 ps / 1 ps
module top_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19129_6ngu5fy #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 173,
		...
		input  wire [172:0] in_data,           //          .data,          Input Data port of Avalon Streaming Sink Interface
		...
		output wire [172:0] out_data           //          .data,          Output Data port of Avalon Streaming Source Interface
	);
	...
	top_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),           //   input,  width = 173,          .data
		...
		.out_data          (out_data),          //  output,  width = 173,          .data
