...
# ACDS 26.1 110 linux 2026.04.22.02:07:58
...
# ----------------------------------------
# If top_inst_reset_bfm_ip is one of several IP cores in your
...
TOP_LEVEL_NAME="top_inst_reset_bfm_ip.top_inst_reset_bfm_ip"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/opt/altera/qpro_26_1/quartus/"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [top_inst_reset_bfm_ip::get_elab_options $SIMULATOR_TOOL_BITNESS]
...
device_libraries='lpm_ver sgate_ver altera_ver altera_mf_ver altera_lnsim_ver tennm_ver tennm_sm_hps_ver tennm_sm4_hssi_ver tennm_revb_hvio_ver tennm_revb_io96_ver '
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set memory_files [concat $memory_files [top_inst_reset_bfm_ip::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -zlib 1 -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QUARTUS_SIM_LIB_DIR/altera_lnsim.sv"               -work altera_lnsim_ver   
  ...
  xmvlog -zlib 1 -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QUARTUS_SIM_LIB_DIR/cadence/tennm_atoms_ncrypt.sv" -work tennm_ver          
  ...
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_sm_hps.sv"               -work tennm_sm_hps_ver   
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_sm_hps_ncrypt.sv"        -work tennm_sm_hps_ver   
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_sm4_hssi.sv"             -work tennm_sm4_hssi_ver 
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_sm4_hssi_ncrypt.sv"      -work tennm_sm4_hssi_ver 
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_revb_hvio.sv"            -work tennm_revb_hvio_ver
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_revb_hvio_ncrypt.sv"     -work tennm_revb_hvio_ver
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_revb_io96.sv"            -work tennm_revb_io96_ver
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$DEVICES_SIM_LIB_DIR/tennm_revb_io96_ncrypt.sv"     -work tennm_revb_io96_ver
fi
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [top_inst_reset_bfm_ip::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [top_inst_reset_bfm_ip::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [top_inst_reset_bfm_ip::get_dpi_libraries "$QSYS_SIMDIR"]]
